...
function Component()
{
    ...
    installer.componentByName("full.tools.cufflinks").setValue("Virtual", "true");
    installer.componentByName("full.tools.cufflinks").setValue("Default", "false");

    if (validOs && systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.cufflinks").setValue("Virtual", "false");
        installer.componentByName("full.tools.cufflinks").setValue("Default", "true");
    }
}
